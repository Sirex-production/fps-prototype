...
public partial class Contexts : Entitas.IContexts {
    ...
    public ProjContext proj { get; set; }

    public Entitas.IContext[] allContexts { get { return new Entitas.IContext [] { game, proj }; } }

    public Contexts() {
        game = new GameContext();
        proj = new ProjContext();
