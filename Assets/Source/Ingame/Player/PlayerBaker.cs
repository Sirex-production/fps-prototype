...
namespace Ingame.Player
{
	...
	{
		[BoxGroup("Entity")] [Required, SerializeField]
		private GameplayEntityReference gameplayEntityReference;

		[BoxGroup("CharacterControllerMdl")] [Required, SerializeField]
		private CharacterController characterController;

		[BoxGroup("GroundCheckCmp")] [Required, SerializeField]
		private Transform raycastOrigin;

		[BoxGroup("GroundCheckCmp")] [SerializeField] [Min(0f)]
		private float distance;

		[BoxGroup("GroundCheckCmp")] [SerializeField] [Min(0f)]
		private float sphereCastRadius;

		[BoxGroup("HealthCmp")] [SerializeField] [Min(0f)]
		private float currentHealth = 100f;

		[BoxGroup("HealthCmp")] [SerializeField] [Min(0f)]
		private float maxHealth = 100f;

		[BoxGroup("ArmorCmp")] [SerializeField] [Range(0f, 1f)]
		private float percentageOfDamageBlockedByArmor = .25f;

		[BoxGroup("ArmorCmp")] [SerializeField] [Range(0f, 1f)]
		private float percentageOfArmorTaken = .25f;

		[BoxGroup("ArmorCmp")] [SerializeField] [Min(0f)]
		private float maximumArmor = 100f;

		[BoxGroup("ArmorCmp")] [SerializeField] [Min(0f)]
		private float currentArmor = 100f;

		[BoxGroup("MagnetCmp")] [SerializeField] [Min(0f)]
		private float affectDistance = 10f;
